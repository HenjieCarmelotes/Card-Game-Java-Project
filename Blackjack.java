...
public class Blackjack {
	...
	public static void main(String[] args) {
		...
		Scanner stdin = new Scanner(System.in);
	      ...
	      while (true) { //Continue the game until the user run out of money or bet 0.
	   ...
	   static boolean playBlackjack() {
	      ...
	      */
	      ...
	      while (true) {
	           ...
	           do {
	              ...
	              userAction = Character.toUpperCase( stdin.next().charAt(0) );
	      ...
	      */
	      ...
	      /* Gets executed when dealers total is less than or equal to 16. */
